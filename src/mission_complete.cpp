...
std_msgs::Bool missionComplete() {
    ...
    ROS_LOG_TIME(INFO, "gps h: " + std::to_string(current_gps.pose.position.altitude) + " target h: " + std::to_string(current_target_global.z));
    ROS_LOG_TIME(INFO, "gps lat: " + std::to_string(current_gps.pose.position.latitude) + " target lat: " + std::to_string(current_target_global.x));
    ROS_LOG_TIME(INFO, "gps lon: " + std::to_string(current_gps.pose.position.longitude) + " target lon: " + std::to_string(current_target_global.y));
    ROS_LOG_TIME(INFO, "dist: " + std::to_string(dist) + " vert_dist: " + std::to_string(vert_dist) + " hori_dist: " + std::to_string(hori_dist));
